...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        seedUser("rajas.shah.cmfeb26@gmail.com","System Admin", "user@123", "admin");
        seedUser("rajasshah412@gmail.com", "Dr. Sarah Jenkins", "user@123", "faculty");
        seedUser("rajasopshah@gmail.com","Alex Johnson", "user@123", "student");
